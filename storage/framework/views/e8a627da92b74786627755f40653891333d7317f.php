                ...
                <div class="left-content">
                    <div class="container">
                        <div class="row justify-content-end">
                            <a href="<?php echo e(route('manage')); ?>" class="btn btn-veedros btn-Edit">
                                <p>Edit</p>
                            </a>
                        </div>
                        <div class="row">
                            <div class="col-12 col-md-5 ">
                                <div class="user-photo " style="background-image: url(uploads/profilePictures/<?php echo e(Auth::user()->img); ?>);">
                                </div>
                            </div>
                            <div class="col-12 col-md-7  ml-auto">
                                <div class="user-name">
                                    <p class="p1"><?php echo e(Auth::user()->name); ?></p>
                                    <?php if(Auth::user()->location != null): ?>
                                    <p class="p2 text-muted"><i
                                            class="fas fa-globe-americas mr-2"></i><?php echo e(Auth::user()->location); ?></p>
                                        <?php endif; ?>
                                </div>
                            </div>
                        </div>
