...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-5 ">
                                <div class="user-photo " style="background-image: url(images/01.jpg);">

                                    <div class='text' onclick="location.href='https://www.veedros.com/profile.html#'">
                                        <p>Edit</p>
                                    </div>
                            ...
                            <div class="col-12 col-md-7  ml-auto">
                                <div class="user-name">
                                    <p class="p1">Aly yassin</p>
                                    <P class="p2 text-muted d-flex justify-content-around"><i
    ...
    <div class="container">
        <ul class="nav nav-pills nav-justified">
            <li class="nav-item shadow-lg m-1">
            ...
            <li class="nav-item disabled shadow-lg m-1">
        ...
        <div class="tab-content ">
            ...
            <div id="My_Courses" class="tab-pane fade in  active show">
                <div class="dashboard-land ">
                    ...
                    <div class="row shadow-lg  m-5 rounded-lg-mine">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="container">
                                ...
                                <div class="d-flex justify-content-end mb-3 ">
                                    <button class="btn btn-veedros btn-veedros-md border-0 mx-2" type="button">
                                        share
                                    </button>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/k/Documents/Web/Laravel/veedros/resources/views/dashboard.blade.php ENDPATH**/ ?>