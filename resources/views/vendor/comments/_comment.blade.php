                        ...
                        <div class="card card-comment border-0">
                            <div class="card-body row">
                                <div class="col-9">
                                    ...
                                    <p class="mt-2" style="white-space: pre-wrap;">{!! $markdown->line($comment->comment) !!}</p>
                                </div>
                                ...
                                @can('reply-to-comment', $comment)
                                    <button data-toggle="modal"
                                            ...
                                            class="btn btn-veedros-sm btn-veedros-alt-white text-uppercase mt-3 ml-auto mr-3">
                                        <i class="mr-2" data-feather="edit-3"></i>Reply</button>
                                @endcan

                                @can('edit-comment', $comment)
                                    <button data-toggle="modal"
                                            data-target="#comment-modal-{{ $comment->getKey() }}"
                                            class="btn btn-veedros-sm btn-veedros-alt-white text-uppercase mt-3 ml-auto">
                                        <i class="mr-2" data-feather="edit"></i>Edit</button>
                                @endcan
                                ...
                                @can('delete-comment', $comment)
                                    <a href="{{ route('comments.destroy', $comment->getKey()) }}" onclick="event.preventDefault();document.getElementById('comment-delete-form-{{ $comment->getKey() }}').submit();"
                                       class="btn btn-veedros-sm btn-veedros-alt-white text-uppercase mt-3 mx-3" style="background-color: #D36565 !important; color: white !important;">
                                        <i class="mr-2" style="stroke: white !important;" data-feather="trash"></i>Delete</a>
